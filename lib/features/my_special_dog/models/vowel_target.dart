...
class MySpecialDogConstants {
  MySpecialDogConstants._();
...
/// Game levels for the My Special Dog (vowel hand) game.
enum MySpecialDogLevel {
  ...
  /// Level 3: Same as Level 2 but a word only scores if guessed with no mistakes
  noMistakes(
    number: 3,
    name: 'No Mistakes',
    description: 'Perfect guesses only',
  );

  /// The level number (1–3)
  final int number;
