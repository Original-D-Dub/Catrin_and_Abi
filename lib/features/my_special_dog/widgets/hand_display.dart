  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final aspectRatio = MySpecialDogConstants.svgViewBoxWidth /
            MySpecialDogConstants.svgViewBoxHeight;
        ...
        return SizedBox(
          ...
          child: Stack(
            children: [
              ...
              // ...MySpecialDogConstants.targets.map((target) {
