...
import 'simple_room_manager.dart';

/// The Flame game for Letter Quest Level 2 (simple room).
///
/// Manages a simpler game world with a single 1200x1200 room divided
/// by a horizontal wall with two doorways.
///
/// Uses the same mechanics as Level 3:
/// - Touch and drag Pero to move
/// - Letter collection in order
/// - 3 words to complete
/// - Victory overlay on completion
class SimpleQuestGame extends BaseLetterQuestGame {
  ...
  late final SimpleRoomManager roomManager;

  /// Whether the provider listener has been attached
  bool _listenerAttached = false;

  /// Creates the Simple Quest game.
  SimpleQuestGame({required this.provider});
  ...
  Future<void> onLoad() async {
    ...
    // Pre-load floor tile for simple room
    await images.load('games/letter_quest/floor-tile-wood-pale.png');

    // Pre-load wall tile for simple room
